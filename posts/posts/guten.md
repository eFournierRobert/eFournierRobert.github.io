...
The most used tooling always has to account for the use cases of an enormous amount of users,
...
time and complexity 
was low. So, I made Guten and we'll see in this article why I did this and we'll do a small overview of 
how it affected my website both good and bad.
...
Lets say I wanted to make a template that lists all the *posts* on my website. With Liquid, it
...
This is something more personal, and I don't know how it affects other Linux distributions or OS,
...
Having to juggle
versions of libraries and not having conflicting versions can become complicated very quickly. Python brought virtual
environments, but I think it feels like a workaround to the problem instead of an elegant solution. 
...
This is much simpler and doesn't interfer much with the HTML. The removal of Liquid also meant that my
Markdown became standard Markdown. This made me able to do other things with the files if I wish so,
since the syntax isn't directly attach to Guten.

You can see how all of this made my repository much smaller than with Jekyll, without loosing much
functionnalities. Guten implements just enough of what Jekyll does that my website can work fine on it.
...
if I start having a lot repeating HTML. The ideal would be a solution that I could write once and let
Guten make the copies.

Another thing I lost is previews. If we take our example of listing *posts*, Liquid allows me to make
a custom HTML template for it. This is useful to customize the website. Right now, Guten has an
...
the functionnalities I need can be implemented, over time, when I need them. 

Right now, Guten works more than fine for what I need it to do and this is the joy of custom tooling.
We spend a lot of time using tools and, sometimes, we bend over backward and spend so much efforts 
