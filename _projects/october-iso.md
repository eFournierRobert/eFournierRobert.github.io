...
During the 1980s, people used floppy disks for this. One floppy disk would 
...
This file is like another file and it can be passed around, copied on other
...
using a software like Ventoy or dd and you're good to go.
